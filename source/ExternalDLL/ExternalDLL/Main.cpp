...
int main(int argc, char * argv[]) {
	...
	ImageIO::debugFolder = "C:\\Users\matth\Downloads";
	...
	if (!ImageIO::loadImage("C:\\Users\\matth\\Source\\Repos\\StpdVision\\testsets\\Set A\\TestSet Images\\child-1.png", *input)) {
		std::cout << "Image could not loaded!" << std::endl;
		system("pause");
		return 0;
	}
